...
//
// The program should use an array of at least 20 structures. It should let
// the user enter data into the array, change the contents of any element,
// and display all the data stored in the array. The program should have
// a menu-driven interface.
//
// Input validation: when the data for a new account is entered, be sure the
// user enters data for all fields. No negative account balances should be
// entered.
//
//
