...
// an entire year. When the program runs, it should ask the use to enter data
// for each month. Once the data are entered for all the months, the program
// should calculate and display the average monthly total rainfall, the total
// rainfall for the year, the highest and lowest temperatures for the year (and
// the months they occurred in), and the average of all the monthly average
// temperatures.
//
// Input validation: only accept temperatures within the range -100 to +140
// degrees Fahrenheit.
//
//
